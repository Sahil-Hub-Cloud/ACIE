...
const WAR_ROOM_CODE = `export default async function handler(req, res) {
...
fs.writeFileSync('api/war-room.js', WAR_ROOM_CODE);
console.log('✅ api/war-room.js upgraded with full color system and animations.');
