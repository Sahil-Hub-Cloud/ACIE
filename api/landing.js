...
.nav{position:fixed;top:0;left:0;right:0;z-index:100;background:rgba(10,14,26,0.85);backdrop-filter:blur(20px);border-bottom:1px solid rgba(124,58,237,0.2);padding:16px 48px;display:flex;justify-content:space-between;align-items:center}
...
.nav-cta{background:linear-gradient(135deg,#7c3aed,#3b82f6);color:#fff !important;padding:10px 24px;border-radius:8px;font-size:14px;font-weight:600}
...
.hero::before{content:'';position:absolute;width:700px;height:700px;background:radial-gradient(circle,rgba(124,58,237,0.12) 0%,transparent 70%);top:50%;left:50%;transform:translate(-50%,-50%);pointer-events:none}
.badge{display:inline-flex;align-items:center;gap:8px;background:rgba(124,58,237,0.15);border:1px solid rgba(124,58,237,0.4);color:#a78bfa;font-size:12px;font-weight:600;padding:6px 16px;border-radius:20px;margin-bottom:32px}
...
.btn-primary{background:linear-gradient(135deg,#7c3aed,#3b82f6);color:#fff;padding:16px 36px;border-radius:10px;font-size:16px;font-weight:600;text-decoration:none}
.btn-secondary{background:rgba(255,255,255,0.05);color:#e2e8f0;border:1px solid rgba(255,255,255,0.1);padding:16px 36px;border-radius:10px;font-size:16px;font-weight:600;text-decoration:none}
.stats{display:flex;justify-content:center;gap:0;margin:60px auto;max-width:800px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;overflow:hidden}
...
.section-title{font-size:clamp(28px,4vw,42px);font-weight:700;color:#fff;text-align:center;margin-bottom:48px;letter-spacing:-1px}
.features-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}
.feature-card{background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:28px;transition:all .3s}
...
<body>
<nav class="nav">
  <a href="/" class="logo"><div class="logo-icon">A</div><span class="logo-text">ACIE</span></a>
  <div class="nav-links">
...
<div style="max-width:1100px;margin:0 auto;padding:0 24px">
  <div class="stats">
    <div class="stat"><div class="stat-num">PRs</div><div class="stat-label">Analyzed automatically</div></div>
    ...
    <div class="stat"><div class="stat-num">0</div><div class="stat-label">Setup needed</div></div>
  </div>
</div>
<div class="section">
  ...
  <div class="features-grid">
    <div class="feature-card"><div class="feature-icon">💥</div><h3>Blast Radius Detection</h3><p>Scans the entire repo to find every file affected by your change before merging.</p></div>
    <div class="feature-card"><div class="feature-icon">🎯</div><h3>Risk Scoring</h3><p>Automatic LOW, MEDIUM, HIGH scores based on real dependency analysis.</p></div>
    <div class="feature-card"><div class="feature-icon">📊</div><h3>Health Score</h3><p>0 to 100 percent code health score per file like Google Lighthouse for pull requests.</p></div>
    <div class="feature-card"><div class="feature-icon">🛡️</div><h3>Security Scanner</h3><p>Detects hardcoded secrets and API keys before they reach production.</p></div>
  ...
  <div class="demo-inner">
    ...
    <div class="demo-window">
      <div class="demo-bar">
        ...
        <span class="demo-title">ACIE Change Impact Report</span>
      </div>
      <div class="demo-body">
        <div class="c1">## ACIE - Change Impact Report</div>
        <div class="c5">### Health Score: 75%</div>
        <div class="c5">Risk Level: MEDIUM | Files: 2 | Blast Radius: 1</div>
        <div class="c1">### File Analysis</div>
        <div class="c2">src/auth.ts - 100% - 3 exports - none</div>
        <div class="c3">src/payment.ts - 50% - deep nesting detected</div>
        <div class="c1">### Blast Radius</div>
        <div class="c4">src/checkout.ts is affected</div>
...
<footer>Built by <a href="https://github.com/Sahil-Hub-Cloud">Sahil-Hub-Cloud</a> - <a href="/dashboard">Dashboard</a> - <a href="/pricing">Pricing</a></footer>
</body>
</html>`);
}